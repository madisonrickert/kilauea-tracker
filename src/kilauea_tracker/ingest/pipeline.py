...
from ..archive import load_archive, promote_to_archive
...
from ._reports import IngestReport as IngestReport
from ._reports import IngestRunResult as IngestRunResult
from ._reports import ModelPredictionRecord as ModelPredictionRecord
from ._runreport_serde import (
    _dt_str,
...
def load_latest_run_report() -> IngestRunResult | None:
    ...
    try:
        ...
        return None
    return deserialize_run_report(payload)
